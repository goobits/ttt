...
def mixed_content():
    ...
    response = ai.ask(
        ...
        quality=True,
    )  # Prefer quality for complex analysis
...
def error_handling():
    ...
    response = ai.ask(
        ["What's in this image?", ImageInput("examples/test.jpg")], backend="local"
    )
    ...
    if response.failed:
        ...
        response = ai.ask(
            ["What's in this image?", ImageInput("examples/test.jpg")], backend="cloud"
        )
