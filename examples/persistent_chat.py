...
def session_management():
    ...
    session = PersistentChatSession(
        session_id="project_helper_001",
        system="You are a project management assistant"
    )
    
    # Build conversation
    session.ask("I need to plan a software project with these phases: design, implementation, testing")
