...
class ConfigManager:
    ...
    def display_config(self) -> None:
        ...
        console.print(f"  Default Model: {default_model} {'[dim](user)[/dim]' if is_user_set else '[dim](default)[/dim]'}")
        ...
        console.print(f"  Default Backend: {default_backend} {'[dim](user)[/dim]' if is_user_set else '[dim](default)[/dim]'}")
    ...
    def show_value(self, key: str) -> None:
        ...
        try:
            ...
            if isinstance(current, dict):
                ...
                console.print(f"[bold blue]{key}:[/bold blue] {current} {'[dim](user)[/dim]' if is_user_set else '[dim](default)[/dim]'}")
